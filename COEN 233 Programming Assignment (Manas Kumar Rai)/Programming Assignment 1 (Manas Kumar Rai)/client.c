...
//function to print all the packet details
...
int main(){
	...
	//get payload data from txt file in read text mode
	...
	while(fgets(line, sizeof(line), fp) != NULL) {
		...
		//conditions below to generate different errors
		...
		while(n <= 0 && retryCounter < 3) {
			...
			//send and receive packets and check error method
		...
		//if no ACK received after sending packet 3 times
		if(retryCounter>= 3 ) {

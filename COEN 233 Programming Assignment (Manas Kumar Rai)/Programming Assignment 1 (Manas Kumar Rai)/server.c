...
int main(int argc, char**argv)
{
	...
	while(1) {
		...
		//Case-4 : REJECT Duplicate packet error
		...
		//Case-2 : REJECT length mismatch error
		...
		//Case-3 : REJECT End of packet missing error
		...
		//Case-1 : REJECT out of sequence error
